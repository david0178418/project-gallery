...
import UserProjectsPage from './projects/page';

export default function UserGallery(props: any) {
	return <UserProjectsPage {...props} />;
}
...
// export default async function UserGalleryPage(props: Props) {
